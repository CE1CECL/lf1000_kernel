...
#define TS_DELAY_IN_US_MADRID	 1
#define TS_Y_DELAY_IN_US_MADRID 1
#define TNT_DELAY_IN_US_MADRID  1

#define TS_DELAY_IN_US_EMERALD	 10
#define TS_Y_DELAY_IN_US_EMERALD 10
#define TNT_DELAY_IN_US_EMERALD  18
...
#define TS_A0_MADRID   -12097127
#define TS_A1_MADRID	   52942
#define TS_A2_MADRID	     149
#define TS_A3_MADRID   -12950733
#define TS_A4_MADRID	      78
#define TS_A5_MADRID	   42024
#define TS_A6_MADRID	   65536

#define TS_A0_EMERALD    25786444
#define TS_A1_EMERALD	   -29676
#define TS_A2_EMERALD	     -170
#define TS_A3_EMERALD    21441222
#define TS_A4_EMERALD	     -632
#define TS_A5_EMERALD	   -26927
#define TS_A6_EMERALD	    65536
...
#define MAX_TNT_DOWN_MADRID    19      // Down if all tnt are <= this
#define MIN_TNT_UP_MADRID      520     // UP if any tnt is > this

#define MAX_TNT_DOWN_EMERALD	28
#define MIN_TNT_UP_EMERALD	500
...
static int lf1000_ts2_probe(struct platform_device *pdev)
{
	...
	if( gpio_have_gpio_emerald() )
	{
		t_dev->adc_max_tnt_down  = MAX_TNT_DOWN_EMERALD;
		t_dev->adc_min_tnt_up    = MIN_TNT_UP_EMERALD;
		
		t_dev->delay_in_us	= TS_DELAY_IN_US_EMERALD;
		t_dev->y_delay_in_us	= TS_Y_DELAY_IN_US_EMERALD;
		t_dev->tnt_delay_in_us	= TNT_DELAY_IN_US_EMERALD;
		
		/* set default /etc/pointercal values */
		t_dev->a[0] = TS_A0_EMERALD;
		t_dev->a[1] = TS_A1_EMERALD;
		t_dev->a[2] = TS_A2_EMERALD;
		t_dev->a[3] = TS_A3_EMERALD;
		t_dev->a[4] = TS_A4_EMERALD;
		t_dev->a[5] = TS_A5_EMERALD;
		t_dev->a[6] = TS_A6_EMERALD;
	...
	{
		t_dev->adc_max_tnt_down  = MAX_TNT_DOWN_MADRID;
		t_dev->adc_min_tnt_up    = MIN_TNT_UP_MADRID;
		
		t_dev->delay_in_us	= TS_DELAY_IN_US_MADRID;
		t_dev->y_delay_in_us	= TS_Y_DELAY_IN_US_MADRID;
		t_dev->tnt_delay_in_us	= TNT_DELAY_IN_US_MADRID;
		
		/* set default /etc/pointercal values */
		t_dev->a[0] = TS_A0_MADRID;
		t_dev->a[1] = TS_A1_MADRID;
		t_dev->a[2] = TS_A2_MADRID;
		t_dev->a[3] = TS_A3_MADRID;
		t_dev->a[4] = TS_A4_MADRID;
		t_dev->a[5] = TS_A5_MADRID;
		t_dev->a[6] = TS_A6_MADRID;
